...
> = {
  is_main_frame: {
    ...
    renderer: '("frameToken" in webFrame && webFrame.top && "frameToken" in webFrame.top) ? webFrame.top.frameToken === webFrame.frameToken : webFrame.top?.routingId === webFrame.routingId',
    type: 'Boolean',
  },
  is_packaged: {
    depends_on_url: false,
